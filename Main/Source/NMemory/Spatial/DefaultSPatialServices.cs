...
namespace NMemory.Spatial
{
    ...
    internal sealed class DefaultSpatialServices : DbSpatialServices
    {
        ...
        private sealed class ReadOnlySpatialValues
        {
            ...
            {
                CoordinateSystemId = spatialRefSysId;
                wkb = (byte[])binaryValue?.Clone();
                Text = textValue;
                GML = gmlValue;
            }

            internal int CoordinateSystemId { get; }
        ...
        {
            return new NotImplementedException("No usable spatial provider could be found.");
        }
        ...
        private static ReadOnlySpatialValues CheckProviderValue(object providerValue)
        {
            ...
            {
                throw new ArgumentException("The specified provider value is not compatible with this spatial services implementation.", nameof(providerValue));
            }
        ...
        private static ReadOnlySpatialValues CheckCompatible(DbGeography geographyValue)
        {
            ...
            throw new ArgumentException("The specified DbGeography value is not compatible with this spatial services implementation.", nameof(geographyValue));
        }
        ...
        private static ReadOnlySpatialValues CheckCompatible(DbGeometry geometryValue)
        {
            ...
            throw new ArgumentException("The specified DbGeometry value is not compatible with this spatial services implementation.", nameof(geometryValue));
        }
